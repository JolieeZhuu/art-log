...
export async function getPaymentNum(id) {
    // initializations
...
export async function addPaymentNum(id) {
    // initializations
    const requests = new Controller();
    const studentUrl = "http://localhost:8080/student/";
...
export async function addNewPaymentTable(id, date, paymentNum) {
    // initializations
    const requests = new Controller();
...
async function generateClasses(id, date, paymentNum) {
    // initializations
    const requests = new Controller();
    const attendanceUrl = "http://localhost:8080/attendance/";
